...
let markup = "";
const countriesApiService = new (0, _fetchCountriesJsDefault.default)();
searchBox.addEventListener("input", (0, _lodashDebounceDefault.default)(getRequestedCountry, DEBOUNCE_DELAY));
...
},{"./css/styles.css":"1CY4s","notiflix":"5z0Oc","notiflix/dist/notiflix-3.2.6.min.css":"1IPtg","lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./fetchCountries.js":"fTQqv"}],"1CY4s":[function() {},{}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"1IPtg":[function() {},{}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
class CountriesApiService {
    ...
    fetchCountries() {
        ...
        return fetch(url).then((response)=>{
            ...
            console.log(data);
            return data;
        }).catch((error)=>(0, _notiflixDefault.default).Notify.failure("Oops, there is no country with that name"));
    }
    get searchCountry() {
...
exports.default = CountriesApiService;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc","notiflix/dist/notiflix-3.2.6.min.css":"1IPtg"}],"1IPtg":[function() {},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
